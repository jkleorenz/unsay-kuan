...
export default function Create({ towns, categories }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Add Business</h2>}>
            ...
            <div className="py-12">
                <div className="mx-auto max-w-2xl sm:px-6 lg:px-8">
                    ...
                    <h1 className="text-xl font-semibold text-gray-900 mt-4 mb-6">Add Business</h1>
