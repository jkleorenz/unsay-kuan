...
export default function Create({ businesses, towns }) {
    ...
    return (
        <AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Post a Job</h2>}>
            <Head title="Post Job" />
            <div className="py-12">
                <div className="mx-auto max-w-2xl sm:px-6 lg:px-8">
                    ...
                    <h1 className="text-xl font-semibold text-gray-900 mt-4 mb-6">Post a Job</h1>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        <div className="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                {errors.business_id && <p className="text-sm text-danger mt-1">{errors.business_id}</p>}
                            </div>
                            <div>
                        ...
                        <div className="flex gap-3 pt-4">
                            <button type="submit" disabled={processing} className="px-4 py-2 bg-accent-500 text-white rounded-md text-sm font-medium hover:bg-accent-600 disabled:opacity-50 transition-colors duration-150">Post Job</button>
